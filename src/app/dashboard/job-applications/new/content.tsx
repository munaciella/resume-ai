...
export default function NewApplicationPageContent() {
    ...
    return (
      <div className="max-w-xl mx-auto text-center py-24 space-y-4">
        ...
        <p className="text-lg font-medium">
          Please select a job from your Saved Job Details before creating or tracking an application.
        </p>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-14 space-y-6">
      <h1 className="text-3xl font-bold text-primary">🎯 Add New or Edit Job Application</h1>
